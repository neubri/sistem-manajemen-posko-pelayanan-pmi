 ...
 */
public class cetak_faktur_Petugas extends javax.swing.JPanel {

    
    public cetak_faktur_Petugas() {
        initComponents();
        aktif();
    }
 ...
 DateFormat dateFormat = new SimpleDateFormat("dd MMMM yyyy");
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Cetak Faktur Petugas");

        jLabel5.setFont(new java.awt.Font("SansSerif", 1, 14)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(102, 102, 102));
        jLabel5.setText("Cetak Faktur > Petugas");
                ...
                .addGroup(custom_JPanelRounded1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(custom_JPanelRounded1Layout.createSequentialGroup()
                        ...
                        .addGroup(custom_JPanelRounded1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(txtIdPtgs, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        custom_JPanelRounded1Layout.setVerticalGroup(
            ...
            .addGroup(custom_JPanelRounded1Layout.createSequentialGroup()
                ...
                .addGroup(custom_JPanelRounded1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel3)
                    .addComponent(txtIdPtgs, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void ctkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ctkActionPerformed
        try {
            new cetak_faktur_Petugas().printComponents(null);
            jTextArea.print();
            jTextArea.setText("");
            txtIdPtgs.setText("");
    ...
    private void bcariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bcariActionPerformed
        String petugas = txtIdPtgs.getText();
        try{
            ...
            String sql="select * from petugas where "+ "id_petugas='" +txtIdPtgs.getText()
            +"'";
            ResultSet rs = statement.executeQuery(sql);
            if (rs.next()){
                jTextArea.setText("                       *** FAKTUR DATA PETUGAS  ***"+
                    "\n                                              PMI"+
                    "\n                                      Telp.081292521111"+
                    "\n============================================"+
                    "\n===========BUKTI DATA PETUGAS===========" + "\n"
                    + "ID Petugas         : " + rs.getString(1) + "\n"
                    + "Nama Petugas       : " + rs.getString(2) + "\n"
                    + "Tanggal Lahir      : " + rs.getString(3) + "\n"
                    + "Jenis Kelamin      : " + rs.getString(4) +"\n"
                    + "Jabatan            : " + rs.getString(5) +"\n"
                    + "Telepon            : " + rs.getString(6) +"\n"
                    + "Alamat             : " + rs.getString(7) +"\n"
                    +

                    "\n============================================"+
                    "\n        Mohon Disimpan Bukti Data Petugas Ini"+
                    "\n");
            }else{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(cetak_faktur_Petugas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new cetak_faktur_Petugas().setVisible(true);
            }
        });
    }
