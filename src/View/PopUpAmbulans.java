 ...
 */
public class PopUpAmbulans extends javax.swing.JFrame {
 Connection conn = controller.koneksi.getKoneksi();
ResultSet rs = null;
PreparedStatement pst = null; 
int xx , xy;
private DefaultTableModel tabmode;
public Menu_Penerimaan Rpa = null;
    /**
     * Creates new form PopUpPasien
     */
    public PopUpAmbulans() {
        initComponents();
        datatable();
    }

     protected void datatable(){
 Object[] Baris ={"Id Ambulans","Jenis Kendaraan"};
 ...
 tblpopupambulans.setModel(tabmode);
 } catch (Exception e) {
    ...
    private void initComponents() {
        ...
        tblpopupambulans = new Custom.Custom_JTable();
        ...
        tblpopupambulans.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        tblpopupambulans.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tblpopupambulansMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(tblpopupambulans);
        ...
        jLabel1.setText("POP UP AMBULANS");
    ...
    private void tblpopupambulansMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblpopupambulansMouseClicked
    int tabelambulans1 = tblpopupambulans.getSelectedRow();
Rpa.IdAmb = tblpopupambulans.getValueAt(tabelambulans1, 0).toString();
Rpa.jenis = tblpopupambulans.getValueAt(tabelambulans1, 1).toString();
Rpa.itemTerpilihAmbulans();
this.dispose();
    }//GEN-LAST:event_tblpopupambulansMouseClicked
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PopUpAmbulans.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PopUpAmbulans().setVisible(true);
            }
        });
    }
    ...
    private Custom.Custom_JTable tblpopupambulans;
