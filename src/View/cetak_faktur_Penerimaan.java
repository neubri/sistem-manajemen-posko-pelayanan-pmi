 ...
 */
public class cetak_faktur_Penerimaan extends javax.swing.JPanel {

    
    public cetak_faktur_Penerimaan() {
        initComponents();
        aktif();
    }
 ...
 DateFormat dateFormat = new SimpleDateFormat("dd MMMM yyyy");
    ...
    private void initComponents() {
        ...
        txtidterima = new Custom.Custom_JTextFieldRounded();
        ...
        jLabel3.setText("ID Terima");

        txtidterima.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtidterimaActionPerformed(evt);
            }
        });
        ...
        jLabel4.setText("Cetak Faktur Penerimaan");

        jLabel5.setFont(new java.awt.Font("SansSerif", 1, 14)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(102, 102, 102));
        jLabel5.setText("Cetak Faktur > Penerimaan");
                ...
                .addGroup(custom_JPanelRounded1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(custom_JPanelRounded1Layout.createSequentialGroup()
                        ...
                        .addGroup(custom_JPanelRounded1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(txtidterima, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        custom_JPanelRounded1Layout.setVerticalGroup(
            ...
            .addGroup(custom_JPanelRounded1Layout.createSequentialGroup()
                ...
                .addGroup(custom_JPanelRounded1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel3)
                    .addComponent(txtidterima, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void txtidterimaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtidterimaActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtidterimaActionPerformed

    private void ctkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ctkActionPerformed
        try {
            new cetak_faktur_Penerimaan().printComponents(null);
            jTextArea.print();
            jTextArea.setText("");
            txtidterima.setText("");
    ...
    private void bcariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bcariActionPerformed
        String penerimaan = txtidterima.getText();
        try{
            ...
            String sql="select * from penerimaan where "+ "id_terima='" +txtidterima.getText()
            +"'";
            ResultSet rs = statement.executeQuery(sql);
            if (rs.next()){
                jTextArea.setText("                       *** FAKTUR PENERIMAAN  ***"+
                    "\n                           PMI"+
                    "\n                                      Telp.081292521111"+
                    "\n============================================"+
                    "\n===========BUKTI PENERIMAAN===========" + "\n"
                    + "ID Terima          : " + rs.getString(1) + "\n"
                    + "NIK Pasien         : " + rs.getString(2) + "\n"
                    + "Nama Pasien        : " + rs.getString(3) + "\n"
                    + "Jenis Kelamin      : " + rs.getString(4) +"\n"
                    + "ID Petugas         : " + rs.getString(5) +"\n"
                    + "Nama Petugas       : " + rs.getString(6) +"\n"
                    + "ID Ambulan         : " + rs.getString(7) +"\n"
                    + "Jenis Kendaraan    : " + rs.getString(8) +"\n"
                    + "Jenis Kejadian     : " + rs.getString(9) +"\n"
                    + "Waktu              : " + rs.getString(10) +"\n"
                    + "Keterangan         : " + rs.getString(11) +"\n"
                    +

                    "\n============================================"+
                    "\n        Mohon Disimpan Bukti Penerimaan Ini"+
                    "\n");
            }else{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(cetak_faktur_Penerimaan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new cetak_faktur_Penerimaan().setVisible(true);
            }
        });
    }
    ...
    private Custom.Custom_JTextFieldRounded txtidterima;
