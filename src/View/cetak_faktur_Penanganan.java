 ...
 */
public class cetak_faktur_Penanganan extends javax.swing.JPanel {

    
    public cetak_faktur_Penanganan() {
        initComponents();
        aktif();
    }
 ...
 DateFormat dateFormat = new SimpleDateFormat("dd MMMM yyyy");
    ...
    private void initComponents() {
        ...
        txtidpenanganan = new Custom.Custom_JTextFieldRounded();
        ...
        jLabel4.setText("Cetak Faktur Penanganan");

        jLabel5.setFont(new java.awt.Font("SansSerif", 1, 14)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(102, 102, 102));
        jLabel5.setText("Cetak Faktur > Penanganan");
                ...
                .addGroup(custom_JPanelRounded1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(custom_JPanelRounded1Layout.createSequentialGroup()
                        ...
                        .addGroup(custom_JPanelRounded1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(txtidpenanganan, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        custom_JPanelRounded1Layout.setVerticalGroup(
            ...
            .addGroup(custom_JPanelRounded1Layout.createSequentialGroup()
                ...
                .addGroup(custom_JPanelRounded1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel3)
                    .addComponent(txtidpenanganan, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void ctkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ctkActionPerformed
        try {
            new cetak_faktur_Penanganan().printComponents(null);
            jTextArea.print();
            jTextArea.setText("");
            txtidpenanganan.setText("");
    ...
    private void bcariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bcariActionPerformed
        String penanganan = txtidpenanganan.getText();
        try{
            ...
            String sql="select * from penanganan where "+ "id_penanganan='" +txtidpenanganan.getText()
            +"'";
            ResultSet rs = statement.executeQuery(sql);
            if (rs.next()){
                jTextArea.setText("                       *** FAKTUR PENANGANAN  ***"+
                    "\n                           PMI"+
                    "\n                                      Telp.081292521111"+
                    "\n============================================"+
                    "\n===========BUKTI PENERIMAAN===========" + "\n"
                    + "ID Penanganan      : " + rs.getString(1) + "\n"
                    + "ID Standby         : " + rs.getString(2) + "\n"
                    + "Nama Pasien        : " + rs.getString(3) + "\n"
                    + "Nama Petugas       : " + rs.getString(4) +"\n"
                    + "Keterangan         : " + rs.getString(5) +"\n"
                    + "Waktu              : " + rs.getString(6) +"\n"
                    + "Keterangan Akhir   : " + rs.getString(7) +"\n"
                    +

                    "\n============================================"+
                    "\n        Mohon Disimpan Bukti Penanganan Ini"+
                    "\n");
            }else{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(cetak_faktur_Penanganan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new cetak_faktur_Penanganan().setVisible(true);
            }
        });
    }
    ...
    private Custom.Custom_JTextFieldRounded txtidpenanganan;
